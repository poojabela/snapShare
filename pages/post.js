  ...
  return ( 
      <div className='flex flex-col items-center mt-[3%]'>
          ...
          <form onSubmit={ handleSubmit } className='flex flex-col'>
              ...
              />
              <button type="submit" disabled={!session.data} className='bg-gradient-to-bl from-[#9933ff] to-[#a31081] py-2 px-8 rounded-xl'>Post ❤</button>
          </form>
          {!session.data && <p className='mt-[2%]'>Sign-in to post</p>}
      </div>
    );
}
